...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-32 w-32 rounded-full object-cover border-[0.20rem] border-white shadow-lg"
            />
          </motion.div>
      ...
      >
        <span className="font-bold">Hello, I'm Emaan developer.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">5 years</span> of experience. I enjoy
        building <span className="italic">landing pages & websites</span>. My
